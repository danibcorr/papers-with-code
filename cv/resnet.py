...
class Double_Residual_Block(layers.Layer):
    ...
    def __init__(self, num_filters: int, stride: int, downsampling: bool):
        ...
        self.branch_block1 = models.Sequential(
            [
                layers.Conv2D(
                    filters=num_filters, kernel_size=3, strides=stride, padding="same"
                ),
    ...
    def call(self, input_tensor: tf.Tensor) -> tf.Tensor:
        ...
        if self.downsampling:
            ...
            branch_connection_input2 = layers.Conv2D(
                filters=self.num_filters,
                kernel_size=1,
                strides=self.stride,
                padding="same",
            )(input_tensor)
            branch_connection_output2 = layers.BatchNormalization()(
                branch_connection_input2
            )
        ...
        concatenation = layers.Add()(
            [branch_connection_output1, branch_connection_output2]
        )
...
class Triple_Residual_Block(layers.Layer):
    ...
    def __init__(self, num_filters: int, increase: int, stride: int):
        ...
        self.branch_block1 = models.Sequential(
            [
                layers.Conv2D(
                    filters=num_filters, kernel_size=1, strides=stride, padding="same"
                ),
                layers.BatchNormalization(),
                layers.ReLU(),
                layers.Conv2D(
    ...
    def call(self, input_tensor: tf.Tensor) -> tf.Tensor:
        ...
        branch_connection_input2 = layers.Conv2D(
            filters=self.num_filters * self.increase,
            kernel_size=1,
            strides=self.stride,
            padding="same",
        )(input_tensor)
    ...
    def __init__(self, configuration: list, increase: int, num_clases: int):
        ...
        if configuration[0] in [18, 34]:
            ...
            for i in range(configuration[1]):
                ...
                self.architecture.add(
                    Double_Residual_Block(num_filters=64, stride=1, downsampling=False)
                )
            ...
            for i in range(configuration[2]):
                ...
                if i == 0:
                    ...
                    self.architecture.add(
                        Double_Residual_Block(
                            num_filters=128, stride=2, downsampling=True
                        )
                    )
                    ...
                    self.architecture.add(
                        Double_Residual_Block(
                            num_filters=128, stride=1, downsampling=False
                        )
                    )
            ...
            for i in range(configuration[3]):
                ...
                if i == 0:
                    ...
                    self.architecture.add(
                        Double_Residual_Block(
                            num_filters=256, stride=2, downsampling=True
                        )
                    )
                    ...
                    self.architecture.add(
                        Double_Residual_Block(
                            num_filters=256, stride=1, downsampling=False
                        )
                    )
            ...
            for i in range(configuration[4]):
                ...
                if i == 0:
                    ...
                    self.architecture.add(
                        Double_Residual_Block(
                            num_filters=512, stride=2, downsampling=True
                        )
                    )
                    ...
                    self.architecture.add(
                        Double_Residual_Block(
                            num_filters=512, stride=1, downsampling=False
                        )
                    )
        ...
        if configuration[0] in [50, 101, 152]:
            ...
            for i in range(configuration[1]):
                ...
                self.architecture.add(
                    Triple_Residual_Block(num_filters=64, increase=increase, stride=1)
                )
            ...
            for i in range(configuration[2]):
                ...
                if i == 0:
                    ...
                    self.architecture.add(
                        Triple_Residual_Block(
                            num_filters=128, increase=increase, stride=2
                        )
                    )
                    ...
                    self.architecture.add(
                        Triple_Residual_Block(
                            num_filters=128, increase=increase, stride=1
                        )
                    )
            ...
            for i in range(configuration[3]):
                ...
                if i == 0:
                    ...
                    self.architecture.add(
                        Triple_Residual_Block(
                            num_filters=256, increase=increase, stride=2
                        )
                    )
                    ...
                    self.architecture.add(
                        Triple_Residual_Block(
                            num_filters=256, increase=increase, stride=1
                        )
                    )
            ...
            for i in range(configuration[4]):
                ...
                if i == 0:
                    ...
                    self.architecture.add(
                        Triple_Residual_Block(
                            num_filters=512, increase=increase, stride=2
                        )
                    )
                    ...
                    self.architecture.add(
                        Triple_Residual_Block(
                            num_filters=512, increase=increase, stride=1
                        )
                    )
