...
class InceptionBlock(layers.Layer):
    ...
    def get_config(self) -> dict:
        ...
        return {
            "num_fil_r1_1": self.num_fil_r1_1,
            "num_fil_r2_1": self.num_fil_r2_1,
            "num_fil_r2_3": self.num_fil_r2_3,
            "num_fil_r3_1": self.num_fil_r3_1,
            "num_fil_r3_5": self.num_fil_r3_5,
            "num_fil_r4_1": self.num_fil_r4_1,
        }
